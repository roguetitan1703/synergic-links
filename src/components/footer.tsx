...
const Footer = () => {
  ...
  return (
    <>
      <div className="relative z-50 bottom-0 left-0 w-full bg-textDark text-textLight py-12 md:py-16">
        ...
        {/* Footer Main Section */}
        <div className="w-full relative flex justify-center items-center h-[300px] -mt-20">
